---
title: "Analysis 1: with biologically relevant transformations"
...
my_vars = c("INIT_BILIRUBIN", "log_BILIRUBIN", 
            "cap_SERUM_SODIUM", "log_cap_SERUM_SODIUM", 
            "INIT_INR", "log_INR", 
            "INIT_SERUM_CREAT", "log_SERUM_CREAT", 
            "cap_ALBUMIN", "log_cap_ALBUMIN", 
            "FEMALE", "DIALYSIS", 
...
3. Capped sodium (truncated between 125 and 137) and log(capped sodium)
4. INR and log(INR)
5. Creatinine and log(creatinine)
6. Dialysis
7. Capped albumin (truncated above at 3.5) and log(capped albumin)
...
# Fit auto-tuners to training data
# ~1 hour + 10 minutes collectively (including benchmarking), with large 
